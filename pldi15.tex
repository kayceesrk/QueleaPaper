...
%formatting for captioning figures
\DeclareCaptionFormat{figformat}{\hrulefill\\#1#2#3}
...
\authorinfo{KC Sivaramakrishnan\thanks{This work was done at Purdue University, USA.}}
...
latency and tolerate partial failures, with the intention of providing a fast,
...
eventually consistent data stores (\ecds), equipped with a \emph{contract}
language, capable of specifying fine-grained application-level consistency
properties. A \emph{contract enforcement system} analyses contracts, and
\emph{automatically} generates the appropriate consistency protocol for the
method protected by the contract. We describe an implementation of \name\ on
top of an off-the-shelf \ecds, that provides support for
...
We thank the anonymous reviewers for their detailed comments.  This work is
supported in part by the National Science Foundation under grants
CCF-1216613 and CCF-1318227.

\renewcommand{\doi}[1]{doi:~\href{http://dx.doi.org/#1}{\Hurl{#1}}}
