...
\SetWatermarkText{\hspace*{8in}\raisebox{7.5in}{\includegraphics[scale=0.1]{aec-badge-pldi}}}
\SetWatermarkAngle{0}
...
\ecds that provides support for \emph{coordination-free} transactions. Several
