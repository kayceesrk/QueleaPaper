...
worst. Under this scheme, \cf{deposit} operations does not need any guarantees,
\cf{getBalance} needs RYW and WFR ($\Delta \vdash \R{RYW} \wedge \R{WFR}
\Rightarrow \cv_{gb}$), and \cf{withdraw} cannot be satisfied ($\Delta \vdash
