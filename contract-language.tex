...
the effect. We admit disjunction in types to let an effect variable range over
...
The $\Delta$ referred in the above definition is a conjunction of assumptions
...
\begin{definition}
An axiomatic executions $\small \E = \Exec$ is said to be well-formed if the
