...
store-consistency level, and is represented by its contract. An edge from a
lower level element to an upper level element corresponds to logical
implication between their corresponding contracts. Classifying a contract under
