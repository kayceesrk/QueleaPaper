...
\le \cv_{st}$ ) if and only if $\Delta \vdash \forall \cureff. \cv_{st} \Rightarrow \cv_{op}$.
\end{definition}
...
supplementary material also provides the concrete reduction rules for enforcing
