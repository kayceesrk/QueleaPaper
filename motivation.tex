...
To prevent \cf{getBalance} from ever showing a negative balance, it is
...
\cf{getBalance} operation that precisely captures this application-level consistency
...
\cf{getBalance} that captures this consistency requirement:
...
The final contract ($\cv_{gb}$) of the \cf{getBalance} operation is
