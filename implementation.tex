...
optional transaction identifier, and \mathi{val is the value associated with the
effect. (eg: \cf{Withdraw 50}).  Since causally consistent operations require an
...
For every transaction, we instantiate a special transaction marker effect
